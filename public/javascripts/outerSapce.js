...
// for the purposes of this test i'll create an array of integers
    ...
    $(window).scroll(function() {
       var hT = $('.hello').offset().top,
           hH = $('.hello').outerHeight(),
           wH = $(window).height(),
           wS = $(this).scrollTop();
    ...
    /*
    $("#collisionParticles").mouseover(function () {
        arpHover1.play();
        $(this).addClass("animationControlBlobs2");
        //$(this).animate({top: "-400px"}, 10000 ); 
    }); */

    $("#collisionParticles").hover(
        function(e){ audioCircleIn.play(); }, // over
        function(e){ audioCircleIn.pause(); }  // out
    );
